...
description: "OpenAPI 3.0 specification for the voice-of-client inference and metadata services."
audience: developer
doc-type: reference
...
openapi: 3.0.3
info:
  title: "voice-of-client API"
  description: |
    RESTful API for the voice-of-client AI Core.
  ...
  contact:
    name: "AI Core Team"
    email: "ai-core-team@example.com"
  license:
    name: "Proprietary"
```,old_string:
servers:
