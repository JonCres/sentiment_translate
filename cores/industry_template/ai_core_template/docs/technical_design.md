...
**Context:** `[INDUSTRY]` has unique business physics and data characteristics.

**Decision:** `[DESCRIBE YOUR MODELING APPROACH - e.g., "Use Survival Analysis + CLTV for Media & Entertainment"]`
...
Example:
- Primary: DeepSurv (Neural Proportional Hazards)
- Secondary: Random Survival Forests (RSF)
- Refinement: XGBoost for residual prediction
- Validation: Concordance Index (C-index), Brier Score
```
