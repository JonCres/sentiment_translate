"""Feature View definitions for Customer survival analyzer Feature Store."""
...
# --- Behavioral Features (XGBoost Refinement) ---
...
behavioral_features_view = FeatureView(
    ...
    online=True,
    tags={"team": "ai_core", "domain": "cltv", "model": "xgboost"},
)
