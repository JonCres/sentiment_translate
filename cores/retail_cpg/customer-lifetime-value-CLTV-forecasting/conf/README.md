...
## 📑 Table of Contents
- [Kedro Configuration Directory](#kedro-configuration-directory)
  ...
  - [How Kedro Uses These Files](#how-kedro-uses-these-files)
    - [1. Parameters in Pipeline Definitions](#1-parameters-in-pipeline-definitions)
    - [2. Parameters in Node Functions](#2-parameters-in-node-functions)
    - [3. Accessing Nested Parameters](#3-accessing-nested-parameters)
