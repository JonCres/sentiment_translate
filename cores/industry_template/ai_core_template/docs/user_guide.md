# User Guide: [AI_CORE_NAME] Cheat Sheet
...
**[AI_CORE_NAME]** helps you `[DESCRIBE PRIMARY BUSINESS VALUE]`.

**Key Capabilities:**
- ✅ `[CAPABILITY 1 - e.g., Predict customer churn 30-90 days in advance]`
- ✅ `[CAPABILITY 2 - e.g., Identify high-value customers for retention]`
- ✅ `[CAPABILITY 3 - e.g., Explain why a customer is at risk]`
- ✅ `[CAPABILITY 4 - e.g., Recommend personalized interventions]`
